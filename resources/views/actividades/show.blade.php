        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 style="margin-left:3%;">Detalles Actividad</h2>
                    <div style="width:45%; padding:2%; margin:5% auto 3% auto; border:1px solid gray; border-radius:6px; background-color:white; display:table; ">
                        <h2 style="text-align:center;">{{$actividad->Nombre}}</h2><br>
                            <ul>
