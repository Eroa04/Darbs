        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 style="margin-left:3%;">Detalles Obra</h2>
                    <div style="width:45%; padding:2%; margin:2% auto 3% auto; border:1px solid gray; border-radius:6px; background-color:white; display:table; ">
                        <h2 style="text-align:center;">{{$obra->Nombre}}</h2><br>
                            <ul>
                                <li><strong> Area:</strong>
                                    {{$obra->Area}}
                                </li>
                                <li><strong> Perimetro:</strong>
                                    {{$obra->Perimetro}}
                                </li>
                                <li><strong> Tipo de Piso:</strong>
                                    {{$obra->TipoPiso}}
                                </li>
                                ...
                                <li><strong> Plano:</strong><br>
                                    <img src="{{asset('storage').'/'.$obra->Plano}}" width="120" height="90">
                                </li>
                            </ul>
                    </div>
                </div>
