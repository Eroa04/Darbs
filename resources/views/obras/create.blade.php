                    ...
                    <div style="width:50%; padding:2%; margin:2% auto 3% auto; border:1px solid gray; border-radius:6px; background-color:white;">
                        <form action="{{url('obras')}}" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    Area:
                                    <input type="text" class="form-control" id="area" name="area" placeholder="Area en metros" value="{{old('area')}}">
                                    @if(count($errors)>0)
                                    <p style="padding:2px; color:red;">{{$errors->first('area')}}</p>
                                    @endif
                                </div>
                                <div class="form-group col-md-6">
                                    Perimetro:
                                    <input type="text" class="form-control" id="perimetro" name="perimetro" placeholder="Perimetro en metros" value="{{old('perimetro')}}">
                                    @if(count($errors)>0)
                                    <p style="padding:2px; color:red;">{{$errors->first('perimetro')}}</p>
                                    @endif
                                </div>
                                <div class="form-group col-md-6">
                                    Tipo de Piso:
                                    <select class="form-control" id="tipopiso" name="tipopiso" style="color:grey;">
                                        ...
                                        <option value="Piso para GYM" {{ old('tipopiso') == "Piso para GYM" ? 'selected' : '' }}>Piso para GYM</option>
                                        <option value="Piso para parque" {{ old('tipopiso') == "Piso para parque" ? 'selected' : '' }}>Piso para parque</option>
                                        <option value="Piso EPDM" {{ old('tipopiso') == "Piso EPDM" ? 'selected' : '' }}>Piso EPDM</option>
                                        <option value="Piso vinilo" {{ old('tipopiso') == "Piso vinilo" ? 'selected' : '' }}>Piso vinilo</option>
                                        <option value="Piso deportivo" {{ old('tipopiso') == "Piso deportivo" ? 'selected' : '' }}>Piso deportivo</option>
                                    </select>
                                    @if(count($errors)>0)
                                    <p style="padding:2px; color:red;">{{$errors->first('tipopiso')}}</p>
                                    @endif
                                </div>
                                <div class="form-group col-md-6">
                                    Direccion:
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    @if(count($errors)>0)
                                    <p style="padding:2px; color:red;">{{$errors->first('plano')}}</p>
                                    @endif
                                </div>
                            </div>
